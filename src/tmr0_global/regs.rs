...
impl Default for Tufsbecr {
    #[inline(always)]
    fn default() -> Tufsbecr {
        Tufsbecr(0u64 as u32)
    }
}
impl core::fmt::Debug for Tufsbecr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Tufsbecr").field("rd", &self.rd()).finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Tufsbecr {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Tufsbecr {
            rd: bool,
        }
        let proxy = Tufsbecr { rd: self.rd() };
        defmt::write!(f, "{}", proxy)
    }
}
...
impl Default for Tufsbesr {
    #[inline(always)]
    fn default() -> Tufsbesr {
        Tufsbesr(0u64 as u32)
    }
}
impl core::fmt::Debug for Tufsbesr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Tufsbesr")
...
#[cfg(feature = "defmt")]
impl defmt::Format for Tufsbesr {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Tufsbesr {
            sb_id: u8,
