...
impl Psiidr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn mr1(&self) -> bool {
        let val = (self.0 >> 1usize) & 0x01;
        val != 0
    }
    #[doc = "Message received from VSI n 0 No message received 1 Message received"]
    #[inline(always)]
    pub const fn set_mr1(&mut self, val: bool) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn flr1(&self) -> bool {
        let val = (self.0 >> 17usize) & 0x01;
        val != 0
    }
    #[doc = "Function level reset of VF initiated by VSI n 0 No reset 1 Reset"]
    #[inline(always)]
    pub const fn set_flr1(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
    }
}
impl Default for Psiidr {
    #[inline(always)]
    fn default() -> Psiidr {
        Psiidr(0u64 as u32)
    }
}
impl core::fmt::Debug for Psiidr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Psiidr")
            .field("txr", &self.txr())
            .field("mr1", &self.mr1())
            .field("rxr", &self.rxr())
            .field("flr1", &self.flr1())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Psiidr {
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Psiier(pub u32);
impl Psiier {
    #[doc = "Message receive interrupt enable, initiated by VSI n 0 Disabled 1 Enabled"]
    #[must_use]
    #[inline(always)]
    pub const fn mr1ie(&self) -> bool {
        let val = (self.0 >> 1usize) & 0x01;
        val != 0
    }
    #[doc = "Message receive interrupt enable, initiated by VSI n 0 Disabled 1 Enabled"]
    #[inline(always)]
    pub const fn set_mr1ie(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
    }
    #[doc = "Function level reset interrupt enable, initiated by VSI n 0 Disabled 1 Enabled"]
    #[must_use]
    #[inline(always)]
    pub const fn flr1ie(&self) -> bool {
        let val = (self.0 >> 17usize) & 0x01;
        val != 0
    }
    #[doc = "Function level reset interrupt enable, initiated by VSI n 0 Disabled 1 Enabled"]
    #[inline(always)]
    pub const fn set_flr1ie(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
    }
}
impl Default for Psiier {
    #[inline(always)]
    fn default() -> Psiier {
        Psiier(0u64 as u32)
    }
}
impl core::fmt::Debug for Psiier {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Psiier")
            .field("mr1ie", &self.mr1ie())
            .field("flr1ie", &self.flr1ie())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Psiier {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Psiier {
            mr1ie: bool,
...
impl Psimsgrr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn mc(&self) -> u16 {
        let val = (self.0 >> 16usize) & 0xffff;
        val as u16
    }
    #[doc = "Message code"]
    #[inline(always)]
    pub const fn set_mc(&mut self, val: u16) {
        self.0 = (self.0 & !(0xffff << 16usize)) | (((val as u32) & 0xffff) << 16usize);
    }
}
impl Default for Psimsgrr {
    #[inline(always)]
    fn default() -> Psimsgrr {
        Psimsgrr(0u64 as u32)
    }
}
impl core::fmt::Debug for Psimsgrr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Psimsgrr")
            .field("mr1", &self.mr1())
            .field("mc", &self.mc())
            .finish()
    }
...
#[cfg(feature = "defmt")]
impl defmt::Format for Psimsgrr {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Psimsgrr {
            mr1: bool,
...
impl Psimsgsr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ms1(&self) -> bool {
        let val = (self.0 >> 1usize) & 0x01;
        val != 0
    }
    #[doc = "Message sent to VSI a When this bit is set (b1), from a clear state (b0), the message code provided in the MC field will be sent to the VSI"]
    #[inline(always)]
    pub const fn set_ms1(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
    }
...
impl Default for Psimsgsr {
    #[inline(always)]
    fn default() -> Psimsgsr {
        Psimsgsr(0u64 as u32)
    }
}
impl core::fmt::Debug for Psimsgsr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Psimsgsr")
            .field("ms1", &self.ms1())
            .field("mc", &self.mc())
            .finish()
    }
...
#[cfg(feature = "defmt")]
impl defmt::Format for Psimsgsr {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Psimsgsr {
            ms1: bool,
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Psiv1msgrcvar0(pub u32);
impl Psiv1msgrcvar0 {
...
impl Default for Psiv1msgrcvar0 {
    #[inline(always)]
    fn default() -> Psiv1msgrcvar0 {
        Psiv1msgrcvar0(0u64 as u32)
    }
}
impl core::fmt::Debug for Psiv1msgrcvar0 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Psiv1msgrcvar0")
...
#[cfg(feature = "defmt")]
impl defmt::Format for Psiv1msgrcvar0 {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Psiv1msgrcvar0 {
            msize: u8,
            addrl: u32,
        }
        let proxy = Psiv1msgrcvar0 {
            msize: self.msize(),
            addrl: self.addrl(),
        };
        defmt::write!(f, "{}", proxy)
...
impl Default for Simcar {
    #[inline(always)]
    fn default() -> Simcar {
        Simcar(131074u64 as u32)
    }
}
impl core::fmt::Debug for Simcar {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Simcar")
...
impl Default for Simsivr {
    #[inline(always)]
    fn default() -> Simsivr {
        Simsivr(0u64 as u32)
    }
}
impl core::fmt::Debug for Simsivr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Simsivr")
            .field("vector", &self.vector())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Simsivr {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Simsivr {
            vector: u8,
