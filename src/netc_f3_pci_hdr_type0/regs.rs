...
impl Default for PciCfcEaPe0Base {
    ...
    fn default() -> PciCfcEaPe0Base {
        PciCfcEaPe0Base(1622147074u64 as u32)
    }
}
...
impl Default for PciCfcEaPe1Base {
    ...
    fn default() -> PciCfcEaPe1Base {
        PciCfcEaPe1Base(1623130114u64 as u32)
    }
}
...
impl PciCfcPcipmCtlStat {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pme_en(&self) -> bool {
        let val = (self.0 >> 8usize) & 0x01;
        val != 0
    }
    #[doc = "PME enable Enable function to generate PM_PME messages to Root Complex Event Collector."]
    #[inline(always)]
    pub const fn set_pme_en(&mut self, val: bool) {
...
impl Default for PciCfhDidVid {
    ...
    fn default() -> PciCfhDidVid {
        PciCfhDidVid(3774945623u64 as u32)
    }
}
...
impl Default for PcieCfcRtrCapHdr {
    ...
    fn default() -> PcieCfcRtrCapHdr {
        PcieCfcRtrCapHdr(65570u64 as u32)
    }
}
