...
impl MifCtrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn mem_pwr_st_en(&self) -> super::vals::MemPwrStEn {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::MemPwrStEn::from_bits(val as u8)
    }
    #[doc = "Memory power status will be considered when determining slice power status."]
    #[inline(always)]
    pub const fn set_mem_pwr_st_en(&mut self, val: super::vals::MemPwrStEn) {
...
impl defmt::Format for MifCtrl {
    fn format(&self, f: defmt::Formatter) {
        ...
        struct MifCtrl {
            sw_ctrl_pin: bool,
            mem_pwr_st_en: super::vals::MemPwrStEn,
            lock_cfg: bool,
        }
        let proxy = MifCtrl {
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct MifDlyArrHf(pub u32);
impl MifDlyArrHf {
...
impl Default for MifDlyArrHf {
    #[inline(always)]
    fn default() -> MifDlyArrHf {
        MifDlyArrHf(2u64 as u32)
    }
}
impl core::fmt::Debug for MifDlyArrHf {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MifDlyArrHf")
...
#[cfg(feature = "defmt")]
impl defmt::Format for MifDlyArrHf {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct MifDlyArrHf {
            pre_hi_dly: u16,
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct MifDlySleep(pub u32);
impl MifDlySleep {
    #[doc = "Delay before asserting signal to high, locked by LOCK_CFG field."]
    #[must_use]
    #[inline(always)]
...
impl Default for MifDlySleep {
    #[inline(always)]
    fn default() -> MifDlySleep {
        MifDlySleep(131072u64 as u32)
    }
}
impl core::fmt::Debug for MifDlySleep {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MifDlySleep")
            .field("pre_hi_dly", &self.pre_hi_dly())
            .field("pre_lo_dly", &self.pre_lo_dly())
            .finish()
    }
...
#[cfg(feature = "defmt")]
impl defmt::Format for MifDlySleep {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct MifDlySleep {
            pre_hi_dly: u16,
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct MifMlplArrPdn(pub u32);
impl MifMlplArrPdn {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn sw_arr_pdn(&self) -> bool {
        let val = (self.0 >> 16usize) & 0x01;
        val != 0
    }
    #[doc = "Software control arr pdn"]
    #[inline(always)]
    pub const fn set_sw_arr_pdn(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
    }
}
impl Default for MifMlplArrPdn {
    #[inline(always)]
    fn default() -> MifMlplArrPdn {
        MifMlplArrPdn(192u64 as u32)
    }
}
impl core::fmt::Debug for MifMlplArrPdn {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MifMlplArrPdn")
            .field("mlpl_ctrl", &self.mlpl_ctrl())
            .field("sw_arr_pdn", &self.sw_arr_pdn())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for MifMlplArrPdn {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct MifMlplArrPdn {
            mlpl_ctrl: u8,
            sw_arr_pdn: bool,
        }
        let proxy = MifMlplArrPdn {
            mlpl_ctrl: self.mlpl_ctrl(),
            sw_arr_pdn: self.sw_arr_pdn(),
        };
        defmt::write!(f, "{}", proxy)
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct MifMlplSleep(pub u32);
impl MifMlplSleep {
    #[doc = "Signal behavior at 8 different MLPL settings"]
    #[must_use]
    #[inline(always)]
    ...
    #[must_use]
    #[inline(always)]
    pub const fn sw_sleep(&self) -> bool {
        let val = (self.0 >> 16usize) & 0x01;
        val != 0
    }
    #[doc = "Software control SLEEP"]
    #[inline(always)]
    pub const fn set_sw_sleep(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
    }
}
impl Default for MifMlplSleep {
    #[inline(always)]
    fn default() -> MifMlplSleep {
        MifMlplSleep(192u64 as u32)
    }
}
impl core::fmt::Debug for MifMlplSleep {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MifMlplSleep")
            .field("mlpl_ctrl", &self.mlpl_ctrl())
            .field("sw_sleep", &self.sw_sleep())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for MifMlplSleep {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct MifMlplSleep {
            mlpl_ctrl: u8,
        ...
        let proxy = MifMlplSleep {
            mlpl_ctrl: self.mlpl_ctrl(),
            sw_sleep: self.sw_sleep(),
        };
        defmt::write!(f, "{}", proxy)
    }
}
...
impl MifStat {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn sleep_state(&self) -> bool {
        let val = (self.0 >> 7usize) & 0x01;
        val != 0
    }
    #[doc = "SLEEP status"]
    #[inline(always)]
    pub const fn set_sleep_state(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize);
    }
    #[doc = "ARR_HF_OFF status"]
    #[must_use]
    #[inline(always)]
    pub const fn arr_hf_state(&self) -> bool {
        let val = (self.0 >> 8usize) & 0x01;
        val != 0
    }
    #[doc = "ARR_HF_OFF status"]
    #[inline(always)]
    pub const fn set_arr_hf_state(&mut self, val: bool) {
...
impl core::fmt::Debug for MifStat {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MifStat")
            ...
            .field("arr_hf_state", &self.arr_hf_state())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for MifStat {
    fn format(&self, f: defmt::Formatter) {
        ...
        let proxy = MifStat {
            ...
            arr_hf_state: self.arr_hf_state(),
        };
        defmt::write!(f, "{}", proxy)
    }
}
