...
pub enum TcompFlag {
    ...
    AllBitsSetIndicateAllTriggersCompleted = 0xff,
}
impl TcompFlag {
    #[inline(always)]
...
pub enum TcompIe {
    ...
    AllTriggerCompletesEnabled = 0xff,
}
impl TcompIe {
    #[inline(always)]
...
pub enum TexcNum {
    ...
    AllBitsSetIndicateAllTriggersInterrupted = 0xff,
}
impl TexcNum {
    #[inline(always)]
...
pub enum Tpri {
    ...
    #[doc = "Set to corresponding priority level"]
    CorrespondingLowerPriority3 = 0x03,
    #[doc = "Set to corresponding priority level"]
    CorrespondingLowerPriority4 = 0x04,
    #[doc = "Set to corresponding priority level"]
    CorrespondingLowerPriority5 = 0x05,
    #[doc = "Set to corresponding priority level"]
    CorrespondingLowerPriority6 = 0x06,
...
pub enum Tsrc {
    ...
    CorrespondingTrigger2 = 0x02,
    #[doc = "Corresponding trigger source initiated this conversion."]
    CorrespondingTrigger3 = 0x03,
    #[doc = "Corresponding trigger source initiated this conversion."]
    CorrespondingTrigger4 = 0x04,
    #[doc = "Corresponding trigger source initiated this conversion."]
    CorrespondingTrigger5 = 0x05,
    #[doc = "Corresponding trigger source initiated this conversion."]
    CorrespondingTrigger6 = 0x06,
