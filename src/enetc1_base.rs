...
unsafe impl Send for Enetc1Base {}
unsafe impl Sync for Enetc1Base {}
impl Enetc1Base {
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn smhrbdrmr(
        self,
        n: usize,
    ) -> crate::common::Reg<regs::Smhrbdrmr, crate::common::RW> {
        assert!(n < 15usize);
    ...
    #[inline(always)]
    pub const fn psi1pmar0(self) -> crate::common::Reg<u32, crate::common::RW> {
    ...
    #[inline(always)]
    pub const fn psi1pmar1(self) -> crate::common::Reg<regs::Psi1pmar1, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x2084usize) as _) }
    }
    #[doc = "Port station interface 1 VLAN register"]
    #[inline(always)]
    pub const fn psi1vlanr(self) -> crate::common::Reg<regs::Psi1vlanr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x2088usize) as _) }
    }
    #[doc = "Port station interface 1 configuration register 0"]
    #[inline(always)]
    pub const fn psi1cfgr0(self) -> crate::common::Reg<regs::Psi1cfgr0, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x2090usize) as _) }
    }
    #[doc = "Port station interface 1 configuration register 1"]
    #[inline(always)]
    pub const fn psi1cfgr1(self) -> crate::common::Reg<regs::Psi1cfgr1, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x2094usize) as _) }
    }
    #[doc = "Port station interface 1 configuration register 2"]
    #[inline(always)]
    pub const fn psi1cfgr2(self) -> crate::common::Reg<regs::Psi1cfgr2, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x2098usize) as _) }
    }
    #[doc = "Port station interface 1 VSI MAC address filtering configuration register"]
    #[inline(always)]
    pub const fn psi1vmafcfgr(self) -> crate::common::Reg<regs::Psi1vmafcfgr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x20b0usize) as _) }
    }
    #[doc = "Port station interface 1 VLAN filtering configuration register"]
    #[inline(always)]
    pub const fn psi1vlanfcfgr(self) -> crate::common::Reg<regs::Psi1vlanfcfgr, crate::common::RW> {
    ...
    #[inline(always)]
    pub const fn psi1umhfr0(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x20d0usize) as _) }
    }
    #[doc = "Port station interface 1 unicast MAC hash filter register 1"]
    #[inline(always)]
    pub const fn psi1umhfr1(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x20d4usize) as _) }
    }
    #[doc = "Port station interface 1 multicast MAC hash filter register 0"]
    #[inline(always)]
    pub const fn psi1mmhfr0(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x20d8usize) as _) }
    }
    #[doc = "Port station interface 1 multicast MAC hash filter register 1"]
    #[inline(always)]
    pub const fn psi1mmhfr1(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x20dcusize) as _) }
    }
    #[doc = "Port station interface 1 VLAN hash filter register 0"]
    #[inline(always)]
    pub const fn psi1vhfr0(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x20e0usize) as _) }
    }
    #[doc = "Port station interface 1 VLAN hash filter register 1"]
    #[inline(always)]
    pub const fn psi1vhfr1(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x20e4usize) as _) }
    }
}
#[doc = "Set of registers which provides number of frame discarded by the Ingress Congestion Manager."]
#[derive(Copy, Clone, Eq, PartialEq)]
