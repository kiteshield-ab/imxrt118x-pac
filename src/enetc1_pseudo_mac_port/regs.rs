...
pub struct Ppmcr(pub u32);
impl Ppmcr {
    #[doc = "Transmit Padding"]
    #[must_use]
    #[inline(always)]
    pub const fn txpad(&self) -> bool {
        let val = (self.0 >> 16usize) & 0x01;
        val != 0
    }
    #[doc = "Transmit Padding"]
    #[inline(always)]
    pub const fn set_txpad(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
    }
}
impl Default for Ppmcr {
    #[inline(always)]
    fn default() -> Ppmcr {
        Ppmcr(65536u64 as u32)
    }
}
impl core::fmt::Debug for Ppmcr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Ppmcr")
            .field("txpad", &self.txpad())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Ppmcr {
