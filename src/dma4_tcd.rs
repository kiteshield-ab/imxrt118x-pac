...
unsafe impl Send for Dma4_tcd {}
unsafe impl Sync for Dma4_tcd {}
impl Dma4_tcd {
    #[inline(always)]
    ...
    pub const fn tcd(self, n: usize) -> Tcd {
        assert!(n < 64usize);
        unsafe { Tcd::from_ptr(self.ptr.add(0x0usize + n * 32768usize) as _) }
    }
}
#[doc = "Array of registers: CH_CSR, CH_ES, CH_INT, CH_PRI, CH_SBR, CH_MUX, TCD_SADDR, TCD_SOFF, TCD_ATTR, TCD_NBYTES_MLOFFNO, TCD_NBYTES_MLOFFYES, TCD_SLAST_SDA, TCD_DADDR, TCD_CITER_ELINKYES, TCD_CITER_ELINKNO, TCD_DOFF, TCD_DLAST_SGA, CH_MATTR, TCD_BITER_ELINKYES, TCD_BITER_ELINKNO, TCD_CSR"]
#[derive(Copy, Clone, Eq, PartialEq)]
...
impl Tcd {
    ...
    #[inline(always)]
    pub const fn ch_mattr(self) -> crate::common::Reg<regs::ChMattr, crate::common::RW> {
    ...
    #[doc = "TCD Transfer Size with Minor Loop Offsets Register"]
    #[inline(always)]
