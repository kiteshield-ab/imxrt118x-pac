...
unsafe impl Send for NetcF4PciHdrType0 {}
unsafe impl Sync for NetcF4PciHdrType0 {}
impl NetcF4PciHdrType0 {
    ...
    #[inline(always)]
    pub const fn pci_cfc_ea_pe2_fmt(
        self,
    ) -> crate::common::Reg<regs::PciCfcEaPe2Fmt, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0xc0usize) as _) }
    }
    #[doc = "PCI EA per-entry 2 base register"]
    #[inline(always)]
    pub const fn pci_cfc_ea_pe2_base(
        self,
    ) -> crate::common::Reg<regs::PciCfcEaPe2Base, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0xc4usize) as _) }
    }
    #[doc = "PCI EA per-entry 2 max offset register"]
    #[inline(always)]
    pub const fn pci_cfc_ea_pe2_maxoff(
        self,
    ) -> crate::common::Reg<regs::PciCfcEaPe2Maxoff, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0xc8usize) as _) }
    }
    #[doc = "PCI EA per-entry 2 extended base register"]
    #[inline(always)]
    pub const fn pci_cfc_ea_pe2_ext_base(self) -> crate::common::Reg<u32, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0xccusize) as _) }
    }
    #[doc = "PCI EA per-entry 3 format register"]
    #[inline(always)]
    pub const fn pci_cfc_ea_pe3_fmt(
        self,
    ) -> crate::common::Reg<regs::PciCfcEaPe3Fmt, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0xd0usize) as _) }
    }
    #[doc = "PCI EA per-entry 3 base register"]
    #[inline(always)]
    pub const fn pci_cfc_ea_pe3_base(
        self,
    ) -> crate::common::Reg<regs::PciCfcEaPe3Base, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0xd4usize) as _) }
    }
    #[doc = "PCI EA per-entry 3 max offset register"]
    #[inline(always)]
    pub const fn pci_cfc_ea_pe3_maxoff(
        self,
    ) -> crate::common::Reg<regs::PciCfcEaPe3Maxoff, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0xd8usize) as _) }
    }
    #[doc = "PCI EA per-entry 3 extended base register"]
    #[inline(always)]
    pub const fn pci_cfc_ea_pe3_ext_base(self) -> crate::common::Reg<u32, crate::common::R> {
    ...
    #[inline(always)]
    pub const fn pcie_cfc_sriov_cap_hdr(
        self,
    ) -> crate::common::Reg<regs::PcieCfcSriovCapHdr, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0150usize) as _) }
    }
    #[doc = "PCIe SR-IOV capability register"]
    #[inline(always)]
    pub const fn pcie_cfc_sriov_cap(
        self,
    ) -> crate::common::Reg<regs::PcieCfcSriovCap, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0154usize) as _) }
    }
    #[doc = "PCIe SR-IOV control register"]
    #[inline(always)]
    pub const fn pcie_cfc_sriov_ctl(
        self,
    ) -> crate::common::Reg<regs::PcieCfcSriovCtl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0158usize) as _) }
    }
    #[doc = "PCIe SR-IOV status register"]
    #[inline(always)]
    pub const fn pcie_cfc_sriov_stat(
        self,
    ) -> crate::common::Reg<regs::PcieCfcSriovStat, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x015ausize) as _) }
    }
    #[doc = "PCIe SR-IOV initial VFs register"]
    #[inline(always)]
    pub const fn pcie_cfc_sriov_init_vfs(self) -> crate::common::Reg<u16, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x015cusize) as _) }
    }
    #[doc = "PCIe SR-IOV total VFs register"]
    #[inline(always)]
    pub const fn pcie_cfc_sriov_total_vfs(self) -> crate::common::Reg<u16, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x015eusize) as _) }
    }
    #[doc = "PCIe SR-IOV num VFs register"]
    #[inline(always)]
    pub const fn pcie_cfc_sriov_num_vfs(self) -> crate::common::Reg<u16, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0160usize) as _) }
    }
    #[doc = "PCIe SR-IOV function dependency list register"]
    #[inline(always)]
    pub const fn pcie_cfc_sriov_func_dep_list(self) -> crate::common::Reg<u16, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0162usize) as _) }
    }
    #[doc = "PCIe SR-IOV first VF offset register"]
    #[inline(always)]
    pub const fn pcie_cfc_sriov_first_vf_off(self) -> crate::common::Reg<u16, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0164usize) as _) }
    }
    #[doc = "PCIe SR-IOV VF stride register"]
    #[inline(always)]
    pub const fn pcie_cfc_sriov_vf_stride(self) -> crate::common::Reg<u16, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0166usize) as _) }
    }
    #[doc = "PCIe SR-IOV VF device ID register"]
    #[inline(always)]
    pub const fn pcie_cfc_sriov_vf_dev_id(self) -> crate::common::Reg<u16, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x016ausize) as _) }
    }
    #[doc = "PCIe SR-IOV supported page sizes ID register"]
    #[inline(always)]
    pub const fn pcie_cfc_sriov_sup_page_sizes(self) -> crate::common::Reg<u32, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x016cusize) as _) }
    }
    #[doc = "PCIe SR-IOV system page size ID register"]
    #[inline(always)]
    pub const fn pcie_cfc_sriov_sys_page_size(self) -> crate::common::Reg<u32, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0170usize) as _) }
    }
    #[doc = "PCIe SR-IOV VF base address register a"]
    #[inline(always)]
    pub const fn pcie_cfc_vf_bar(
        self,
        n: usize,
    ) -> crate::common::Reg<regs::PcieCfcVfBar, crate::common::R> {
        assert!(n < 6usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0174usize + n * 4usize) as _) }
    }
    #[doc = "PCIe SR-IOV VF migration state array offset register"]
    #[inline(always)]
    pub const fn pcie_cfc_sriov_vf_mig_state_arr_off(
        self,
