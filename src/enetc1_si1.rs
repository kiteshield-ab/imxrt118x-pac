...
unsafe impl Send for Enetc1Si1 {}
unsafe impl Sync for Enetc1Si1 {}
impl Enetc1Si1 {
    #[inline(always)]
    pub const unsafe fn from_ptr(ptr: *mut ()) -> Self {
        Self { ptr: ptr as _ }
    ...
    #[inline(always)]
    pub const fn vsimsgsr(self) -> crate::common::Reg<regs::Vsimsgsr, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0204usize) as _) }
    }
    #[doc = "Virtual station interface message receive register"]
    #[inline(always)]
    pub const fn vsimsgrr(self) -> crate::common::Reg<regs::Vsimsgrr, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0208usize) as _) }
    }
    #[doc = "Virtual station interface message send register 0"]
    #[inline(always)]
    pub const fn vsimsgsndar0(self) -> crate::common::Reg<regs::Vsimsgsndar0, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0210usize) as _) }
    }
    #[doc = "Virtual station interface message send address register 1"]
    #[inline(always)]
    pub const fn vsimsgsndar1(self) -> crate::common::Reg<u32, crate::common::RW> {
    ...
    #[inline(always)]
    pub const fn siblpr(self, n: usize) -> crate::common::Reg<u32, crate::common::R> {
        assert!(n < 2usize);
    ...
    #[inline(always)]
    pub const fn vsiier(self) -> crate::common::Reg<regs::Vsiier, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0a00usize) as _) }
    }
    #[doc = "Virtual station interface interrupt detect register"]
    #[inline(always)]
    pub const fn vsiidr(self) -> crate::common::Reg<regs::Vsiidr, crate::common::RW> {
