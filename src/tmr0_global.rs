...
unsafe impl Send for Tmr0Global {}
unsafe impl Sync for Tmr0Global {}
impl Tmr0Global {
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn tufsbecr(self) -> crate::common::Reg<regs::Tufsbecr, crate::common::RW> {
    ...
    #[inline(always)]
    pub const fn tufsbesr(self) -> crate::common::Reg<regs::Tufsbesr, crate::common::RW> {
