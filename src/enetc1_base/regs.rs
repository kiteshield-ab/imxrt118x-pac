...
impl Pmr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn si1en(&self) -> bool {
        let val = (self.0 >> 17usize) & 0x01;
        val != 0
    }
    #[doc = "Enable station interface 1"]
    #[inline(always)]
    pub const fn set_si1en(&mut self, val: bool) {
...
impl core::fmt::Debug for Pmr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Pmr")
            .field("si0en", &self.si0en())
            .field("si1en", &self.si1en())
            .finish()
    }
}
#[cfg(feature = "defmt")]
...
impl Default for Psi1cfgr0 {
    #[inline(always)]
    fn default() -> Psi1cfgr0 {
        Psi1cfgr0(0u64 as u32)
    }
}
impl core::fmt::Debug for Psi1cfgr0 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Psi1cfgr0")
            .field("num_tx_bdr", &self.num_tx_bdr())
            .field("spe", &self.spe())
            .field("vte", &self.vte())
            .field("sivie", &self.sivie())
...
#[cfg(feature = "defmt")]
impl defmt::Format for Psi1cfgr0 {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Psi1cfgr0 {
            num_tx_bdr: u8,
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Psi1cfgr1(pub u32);
impl Psi1cfgr1 {
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 0 to set transmit traffic class."]
    #[must_use]
    #[inline(always)]
    pub const fn tc0_map(&self) -> u8 {
        let val = (self.0 >> 0usize) & 0x07;
        val as u8
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 0 to set transmit traffic class."]
    #[inline(always)]
    pub const fn set_tc0_map(&mut self, val: u8) {
        self.0 = (self.0 & !(0x07 << 0usize)) | (((val as u32) & 0x07) << 0usize);
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 1 to set transmit traffic class."]
    #[must_use]
    #[inline(always)]
    pub const fn tc1_map(&self) -> u8 {
        let val = (self.0 >> 4usize) & 0x07;
        val as u8
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 1 to set transmit traffic class."]
    #[inline(always)]
    pub const fn set_tc1_map(&mut self, val: u8) {
        self.0 = (self.0 & !(0x07 << 4usize)) | (((val as u32) & 0x07) << 4usize);
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 2 to set transmit traffic class."]
    #[must_use]
    #[inline(always)]
    pub const fn tc2_map(&self) -> u8 {
        let val = (self.0 >> 8usize) & 0x07;
        val as u8
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 2 to set transmit traffic class."]
    #[inline(always)]
    pub const fn set_tc2_map(&mut self, val: u8) {
        self.0 = (self.0 & !(0x07 << 8usize)) | (((val as u32) & 0x07) << 8usize);
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 3 to set transmit traffic class."]
    #[must_use]
    #[inline(always)]
    pub const fn tc3_map(&self) -> u8 {
        let val = (self.0 >> 12usize) & 0x07;
        val as u8
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 3 to set transmit traffic class."]
    #[inline(always)]
    pub const fn set_tc3_map(&mut self, val: u8) {
        self.0 = (self.0 & !(0x07 << 12usize)) | (((val as u32) & 0x07) << 12usize);
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 4 to set transmit traffic class."]
    #[must_use]
    #[inline(always)]
    pub const fn tc4_map(&self) -> u8 {
        let val = (self.0 >> 16usize) & 0x07;
        val as u8
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 4 to set transmit traffic class."]
    #[inline(always)]
    pub const fn set_tc4_map(&mut self, val: u8) {
        self.0 = (self.0 & !(0x07 << 16usize)) | (((val as u32) & 0x07) << 16usize);
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 5 to set transmit traffic class."]
    #[must_use]
    #[inline(always)]
    pub const fn tc5_map(&self) -> u8 {
        let val = (self.0 >> 20usize) & 0x07;
        val as u8
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 5 to set transmit traffic class."]
    #[inline(always)]
    pub const fn set_tc5_map(&mut self, val: u8) {
        self.0 = (self.0 & !(0x07 << 20usize)) | (((val as u32) & 0x07) << 20usize);
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 6 to set transmit traffic class."]
    #[must_use]
    #[inline(always)]
    pub const fn tc6_map(&self) -> u8 {
        let val = (self.0 >> 24usize) & 0x07;
        val as u8
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 6 to set transmit traffic class."]
    #[inline(always)]
    pub const fn set_tc6_map(&mut self, val: u8) {
        self.0 = (self.0 & !(0x07 << 24usize)) | (((val as u32) & 0x07) << 24usize);
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 7 to set transmit traffic class."]
    #[must_use]
    #[inline(always)]
    pub const fn tc7_map(&self) -> u8 {
        let val = (self.0 >> 28usize) & 0x07;
        val as u8
    }
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 7 to set transmit traffic class."]
    #[inline(always)]
    pub const fn set_tc7_map(&mut self, val: u8) {
        self.0 = (self.0 & !(0x07 << 28usize)) | (((val as u32) & 0x07) << 28usize);
    }
}
impl Default for Psi1cfgr1 {
    #[inline(always)]
    fn default() -> Psi1cfgr1 {
        Psi1cfgr1(1985229328u64 as u32)
    }
}
impl core::fmt::Debug for Psi1cfgr1 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Psi1cfgr1")
            .field("tc0_map", &self.tc0_map())
            .field("tc1_map", &self.tc1_map())
            .field("tc2_map", &self.tc2_map())
            .field("tc3_map", &self.tc3_map())
            .field("tc4_map", &self.tc4_map())
            .field("tc5_map", &self.tc5_map())
            .field("tc6_map", &self.tc6_map())
            .field("tc7_map", &self.tc7_map())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Psi1cfgr1 {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Psi1cfgr1 {
            tc0_map: u8,
        ...
        let proxy = Psi1cfgr1 {
            tc0_map: self.tc0_map(),
            tc1_map: self.tc1_map(),
            tc2_map: self.tc2_map(),
            tc3_map: self.tc3_map(),
            tc4_map: self.tc4_map(),
            tc5_map: self.tc5_map(),
            tc6_map: self.tc6_map(),
            tc7_map: self.tc7_map(),
        };
        defmt::write!(f, "{}", proxy)
    }
}
...
impl Default for Psi1cfgr2 {
    #[inline(always)]
    fn default() -> Psi1cfgr2 {
        Psi1cfgr2(0u64 as u32)
    }
}
impl core::fmt::Debug for Psi1cfgr2 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Psi1cfgr2")
            .field("num_msix", &self.num_msix())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Psi1cfgr2 {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Psi1cfgr2 {
            num_msix: u8,
...
impl Default for Psi1pmar1 {
    #[inline(always)]
    fn default() -> Psi1pmar1 {
        Psi1pmar1(0u64 as u32)
    }
}
impl core::fmt::Debug for Psi1pmar1 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Psi1pmar1")
            .field("prim_mac_addr", &self.prim_mac_addr())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Psi1pmar1 {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Psi1pmar1 {
            prim_mac_addr: u16,
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Psi1vlanfcfgr(pub u32);
impl Psi1vlanfcfgr {
    #[doc = "Number of VLAN filter table entries assigned to the SI"]
    #[must_use]
    #[inline(always)]
...
impl Default for Psi1vlanfcfgr {
    #[inline(always)]
    fn default() -> Psi1vlanfcfgr {
        Psi1vlanfcfgr(0u64 as u32)
    }
}
impl core::fmt::Debug for Psi1vlanfcfgr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Psi1vlanfcfgr")
            .field("num_vlan_fte", &self.num_vlan_fte())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Psi1vlanfcfgr {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Psi1vlanfcfgr {
            num_vlan_fte: u8,
        }
        let proxy = Psi1vlanfcfgr {
            num_vlan_fte: self.num_vlan_fte(),
        };
        defmt::write!(f, "{}", proxy)
    }
...
impl Psi1vlanr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn tpid(&self) -> super::vals::Psi1vlanrTpid {
        let val = (self.0 >> 16usize) & 0x03;
        super::vals::Psi1vlanrTpid::from_bits(val as u8)
    }
    #[doc = "Tag protocol identifier"]
    #[inline(always)]
    pub const fn set_tpid(&mut self, val: super::vals::Psi1vlanrTpid) {
        self.0 = (self.0 & !(0x03 << 16usize)) | (((val.to_bits() as u32) & 0x03) << 16usize);
    }
    #[doc = "Enable"]
    #[must_use]
...
impl Default for Psi1vlanr {
    #[inline(always)]
    fn default() -> Psi1vlanr {
        Psi1vlanr(0u64 as u32)
    }
}
impl core::fmt::Debug for Psi1vlanr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Psi1vlanr")
            .field("vid", &self.vid())
            .field("dei", &self.dei())
            .field("pcp", &self.pcp())
            .field("tpid", &self.tpid())
...
#[cfg(feature = "defmt")]
impl defmt::Format for Psi1vlanr {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Psi1vlanr {
            vid: u16,
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Psi1vmafcfgr(pub u32);
impl Psi1vmafcfgr {
    #[doc = "Number of SI MAC address filter table entries assigned to the SI"]
    #[must_use]
    #[inline(always)]
...
impl Default for Psi1vmafcfgr {
    #[inline(always)]
    fn default() -> Psi1vmafcfgr {
        Psi1vmafcfgr(0u64 as u32)
    }
}
impl core::fmt::Debug for Psi1vmafcfgr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Psi1vmafcfgr")
            .field("num_mac_afte", &self.num_mac_afte())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Psi1vmafcfgr {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Psi1vmafcfgr {
            num_mac_afte: u8,
        }
        let proxy = Psi1vmafcfgr {
            num_mac_afte: self.num_mac_afte(),
        };
        defmt::write!(f, "{}", proxy)
    }
...
impl Psipmmr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn si1_mac_up(&self) -> bool {
        let val = (self.0 >> 1usize) & 0x01;
        val != 0
    }
    #[doc = "SI 1 MAC unicast promiscuous"]
    #[inline(always)]
    pub const fn set_si1_mac_up(&mut self, val: bool) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn si1_mac_mp(&self) -> bool {
        let val = (self.0 >> 17usize) & 0x01;
        val != 0
    }
    #[doc = "SI 1 MAC multicast promiscuous"]
    #[inline(always)]
    pub const fn set_si1_mac_mp(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
    }
}
...
impl core::fmt::Debug for Psipmmr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Psipmmr")
            ...
            .field("si1_mac_up", &self.si1_mac_up())
            .field("si0_mac_mp", &self.si0_mac_mp())
            .field("si1_mac_mp", &self.si1_mac_mp())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Psipmmr {
    fn format(&self, f: defmt::Formatter) {
        ...
        let proxy = Psipmmr {
            ...
            si1_mac_up: self.si1_mac_up(),
            si0_mac_mp: self.si0_mac_mp(),
            si1_mac_mp: self.si1_mac_mp(),
        };
        defmt::write!(f, "{}", proxy)
    }
}
...
impl Psipvmr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn si1_vlan_p(&self) -> bool {
        let val = (self.0 >> 1usize) & 0x01;
        val != 0
    }
    #[doc = "SI 1 VLAN promiscuous. This field specifies if SI 1 qualifies for the reception of all VLAN tags."]
    #[inline(always)]
    pub const fn set_si1_vlan_p(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn si1_vlan_uta(&self) -> super::vals::Si1VlanUta {
        let val = (self.0 >> 17usize) & 0x01;
        super::vals::Si1VlanUta::from_bits(val as u8)
    }
    #[doc = "SI 1 Untagged frames (no VLAN) accepted"]
    #[inline(always)]
    pub const fn set_si1_vlan_uta(&mut self, val: super::vals::Si1VlanUta) {
...
impl core::fmt::Debug for Psipvmr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Psipvmr")
            ...
            .field("si1_vlan_p", &self.si1_vlan_p())
            .field("si0_vlan_uta", &self.si0_vlan_uta())
            .field("si1_vlan_uta", &self.si1_vlan_uta())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Psipvmr {
    fn format(&self, f: defmt::Formatter) {
        ...
        struct Psipvmr {
            ...
            si1_vlan_uta: super::vals::Si1VlanUta,
        }
        let proxy = Psipvmr {
            si0_vlan_p: self.si0_vlan_p(),
            si1_vlan_p: self.si1_vlan_p(),
            si0_vlan_uta: self.si0_vlan_uta(),
            si1_vlan_uta: self.si1_vlan_uta(),
        };
        defmt::write!(f, "{}", proxy)
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Smhrbdrmr(pub u32);
impl Smhrbdrmr {
    #[doc = "Switch management (non-zero) host reason is directed to this receive BD ring"]
    #[must_use]
    #[inline(always)]
    pub const fn rxbdr(&self) -> u8 {
        let val = (self.0 >> 0usize) & 0xff;
        val as u8
    }
    #[doc = "Switch management (non-zero) host reason is directed to this receive BD ring"]
    #[inline(always)]
    pub const fn set_rxbdr(&mut self, val: u8) {
        self.0 = (self.0 & !(0xff << 0usize)) | (((val as u32) & 0xff) << 0usize);
    }
}
impl Default for Smhrbdrmr {
    #[inline(always)]
    fn default() -> Smhrbdrmr {
        Smhrbdrmr(0u64 as u32)
    }
}
impl core::fmt::Debug for Smhrbdrmr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Smhrbdrmr")
            .field("rxbdr", &self.rxbdr())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Smhrbdrmr {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Smhrbdrmr {
            rxbdr: u8,
