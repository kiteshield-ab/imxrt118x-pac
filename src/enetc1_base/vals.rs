...
impl Psi1vlanrTpid {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Psi1vlanrTpid {
        unsafe { core::mem::transmute(val & 0x03) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Psi1vlanrTpid {
    #[inline(always)]
    fn from(val: u8) -> Psi1vlanrTpid {
        Psi1vlanrTpid::from_bits(val)
    }
}
impl From<Psi1vlanrTpid> for u8 {
    #[inline(always)]
    fn from(val: Psi1vlanrTpid) -> u8 {
        Psi1vlanrTpid::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
impl Si1VlanUta {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Si1VlanUta {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Si1VlanUta {
    #[inline(always)]
    fn from(val: u8) -> Si1VlanUta {
        Si1VlanUta::from_bits(val)
    }
}
impl From<Si1VlanUta> for u8 {
    #[inline(always)]
    fn from(val: Si1VlanUta) -> u8 {
        Si1VlanUta::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
