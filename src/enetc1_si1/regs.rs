...
impl Vsiidr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn mr(&self) -> bool {
        let val = (self.0 >> 9usize) & 0x01;
        val != 0
    }
    #[doc = "Message received 0 No message 1 Message received from PSI, see VSIMSGRR"]
    #[inline(always)]
    pub const fn set_mr(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize);
    }
...
impl Default for Vsiidr {
    #[inline(always)]
    fn default() -> Vsiidr {
        Vsiidr(0u64 as u32)
    }
}
impl core::fmt::Debug for Vsiidr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Vsiidr")
            .field("txr", &self.txr())
            .field("ms", &self.ms())
            .field("mr", &self.mr())
            .field("rxr", &self.rxr())
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Vsiier(pub u32);
impl Vsiier {
    #[doc = "Message sent interrupt enable 0 Disabled 1 Enabled"]
    #[must_use]
    #[inline(always)]
    pub const fn msie(&self) -> bool {
        let val = (self.0 >> 8usize) & 0x01;
        val != 0
    }
    #[doc = "Message sent interrupt enable 0 Disabled 1 Enabled"]
    #[inline(always)]
    pub const fn set_msie(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
    }
    #[doc = "Message received interrupt enable 0 Disabled 1 Enabled"]
    #[must_use]
    #[inline(always)]
    pub const fn mrie(&self) -> bool {
        let val = (self.0 >> 9usize) & 0x01;
        val != 0
    }
    #[doc = "Message received interrupt enable 0 Disabled 1 Enabled"]
    #[inline(always)]
    pub const fn set_mrie(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize);
    }
}
impl Default for Vsiier {
    #[inline(always)]
    fn default() -> Vsiier {
        Vsiier(0u64 as u32)
    }
}
impl core::fmt::Debug for Vsiier {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Vsiier")
            .field("msie", &self.msie())
            .field("mrie", &self.mrie())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Vsiier {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Vsiier {
            msie: bool,
...
impl Default for Vsimsgrr {
    #[inline(always)]
    fn default() -> Vsimsgrr {
        Vsimsgrr(0u64 as u32)
    }
}
impl core::fmt::Debug for Vsimsgrr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Vsimsgrr")
            .field("mr", &self.mr())
            .field("mc", &self.mc())
            .finish()
    }
...
#[cfg(feature = "defmt")]
impl defmt::Format for Vsimsgrr {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Vsimsgrr {
            mr: bool,
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Vsimsgsndar0(pub u32);
impl Vsimsgsndar0 {
...
impl Default for Vsimsgsndar0 {
    #[inline(always)]
    fn default() -> Vsimsgsndar0 {
        Vsimsgsndar0(0u64 as u32)
    }
}
impl core::fmt::Debug for Vsimsgsndar0 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Vsimsgsndar0")
...
#[cfg(feature = "defmt")]
impl defmt::Format for Vsimsgsndar0 {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Vsimsgsndar0 {
            msize: u8,
...
impl Default for Vsimsgsr {
    #[inline(always)]
    fn default() -> Vsimsgsr {
        Vsimsgsr(0u64 as u32)
    }
}
impl core::fmt::Debug for Vsimsgsr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Vsimsgsr")
            .field("mb", &self.mb())
            .field("ms", &self.ms())
            .field("mc", &self.mc())
            .finish()
...
#[cfg(feature = "defmt")]
impl defmt::Format for Vsimsgsr {
    fn format(&self, f: defmt::Formatter) {
        #[derive(defmt :: Format)]
        struct Vsimsgsr {
            mb: bool,
