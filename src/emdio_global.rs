...
unsafe impl Send for EmdioGlobal {}
unsafe impl Sync for EmdioGlobal {}
impl EmdioGlobal {
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn emdioufsbecr(self) -> crate::common::Reg<regs::Emdioufsbecr, crate::common::RW> {
    ...
    #[inline(always)]
    pub const fn emdioufsbesr(self) -> crate::common::Reg<regs::Emdioufsbesr, crate::common::RW> {
